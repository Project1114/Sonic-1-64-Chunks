...
GM_Sega:
		...
		bsr.w	NemDec
		lea	(v_lvllayout&$FFFFFF).l,a1
		lea	(Eni_SegaLogo).l,a0 ; load Sega	logo mappings
		move.w	#0,d0
		bsr.w	EniDec

		copyTilemap	v_lvllayout&$FFFFFF,$E510,$17,7
		copyTilemap	(v_lvllayout+$180)&$FFFFFF,$C000,$27,$1B

		if Revision<>0
			tst.b   (v_megadrive).w	; is console Japanese?
			bmi.s   .loadpal
			copyTilemap	(v_lvllayout+$A40)&$FFFFFF,$C53A,2,1 ; hide "TM" with a white rectangle
		endif
...
GM_Title:
		...
		copyTilemap	v_lvllayout&$FFFFFF,$C000,$27,$1B
...
Tit_LoadText:
	...
	;	bsr.w	KosDec
		move.l	#Blk128_GHZ,(v_chunkloc).w
...
loc_47D4:
		...
		move.w	d0,(v_screenposx).w			; MJ: clear screen positions
		move.w	d0,(v_screenposy).w			; MJ: ''
		move.w	d0,(v_bgscreenposx).w			; MJ: ''
		move.w	d0,(v_bgscreenposy).w			; MJ: ''
...
End_SlowFade:
		...
		beq.w	End_AllEmlds
		clr.w	(f_restart).w
	;	move.l	#$AAABAE9A,(v_lvllayout+$200).l ; MJ: modify level layout
	;	move.l	#$ACADAFB0,(v_lvllayout+$300).l
		lea	(v_lvllayout).l,a4			; MJ: load FG layout space
		move.w	#$4000,d6				; MJ: prepare VRAM plane address
		move.w	(v_screenposx).w,d4			; MJ: load X position
		move.w	(v_screenposy).w,d5			; MJ: load Y position
